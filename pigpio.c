...
{
	uint32_t outPin = 23;            // 23 The Broadcom pin number the signal will be sent on
	int frequency = 38000;           // The frequency of the IR signal in Hz
	double dutyCycle = 0.5;          // The duty cycle of the IR signal. 0.5 means for every cycle,
	                                 // the LED will turn on for half the cycle time, and off the other half
	int leadingPulseDuration = 9000; // default - 9000 The duration of the beginning pulse in microseconds
	...
	result = irSling(
		...
		sendTrailingPulse,
		"00000000");
//11110000011100001110000000011111
